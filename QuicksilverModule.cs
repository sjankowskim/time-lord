...
namespace QuicksilverUpdated
{
    public class QuicksilverModule : LevelModule
    {
        ...
        private void StartQuicksilver()
        {
            ...
            orgAnimatorSpeed = Player.currentCreature.animator.speed;
        ...
        { 
            ...
            Player.currentCreature.animator.speed /= Time.timeScale; // ANIMATOR SPEED - Controls how fast the legs move when walking/running
            ...
            Player.local.locomotion.turnSpeed = 1f / Time.timeScale; // PLAYER TURN SPEED - Rotates the player's perspective; found in Locomotion.turnSpeed
        ...
        private void StopQuicksilver()
        {
            ...
            Player.currentCreature.animator.speed = orgAnimatorSpeed;
